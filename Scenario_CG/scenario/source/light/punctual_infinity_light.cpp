...
render::raycasting::Color PunctualInfinityLight::get_light_color(const core::util::Vector3 &eye, const object::Face &face_int, const core::util::Vector3 &p_int, bool prova) const {
