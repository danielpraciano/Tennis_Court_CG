...
public:
    Face(const std::shared_ptr<Material> material, std::shared_ptr<Vertex> v1, std::shared_ptr<Vertex> v2,
         ...
         const Vertex *vertex_right_ref_to_tex = nullptr) : material(material), v1(v1), v2(v2), v3(v3), plan_to_tex_(plan_to_tex),
            vertex_left_ref_to_tex(vertex_left_ref_to_tex), vertex_right_ref_to_tex(vertex_right_ref_to_tex) {
